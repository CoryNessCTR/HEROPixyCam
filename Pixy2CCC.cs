...
namespace HEROPixyCam
{
    class Pixy2CCC
    {
        ...
        public class Block
        {
            ...
            public override string ToString()
            {
                ...
                if (m_signature > CCC_MAX_SIGNATURE) // color code! (CC)
                {
                    ...
                    sig += '\0';
                    return "CC block sig: " + sig + " sig: " + m_signature + " x: " + m_x + " y: " + m_y + " width: " + m_width + " height: " + m_height + " angle: " + m_angle + " index: " + m_index + " age: " + m_age;
                }
        ...
        public int OffsetBlock(ref bool atBounds, int xBoundary = 5, int yBoundary = 5)
        {
